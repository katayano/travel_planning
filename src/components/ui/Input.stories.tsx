...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    "フォーム入力用のテキストフィールドコンポーネントです。ラベル、バリデーション状態、各種入力タイプをサポートしています。",
            },
        },
    },
    tags: ["autodocs"],
...
export const FocusStates: Story = {
    ...
    render: () => (
        <div className="space-y-4 max-w-md">
            <Input label="通常状態" placeholder="クリックしてフォーカス" type="text" />
            <Input label="必須項目" placeholder="必須項目です" type="text" required />
            <Input label="無効状態" value="編集不可" type="text" disabled />
        </div>
    ),
    parameters: {
        docs: {
